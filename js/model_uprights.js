...
function createPost(writing){
    var materials = [palatte.maroon, palatte.maroon, palatte.maroon, palatte.maroon, writing, palatte.maroon];
...
function createUprights() {
   ...
   var leftPost = createPost(palatte.gatepost);
   var rightPost = createPost(palatte.rugbypost);
