...
var face = new THREE.ImageUtils.loadTexture('textures/face.png');
var gpost = new THREE.ImageUtils.loadTexture('textures/gatepost.png');
var rpost = new THREE.ImageUtils.loadTexture('textures/rugbypost.png');
...
var palatte = {
  ...
  gatepost: new THREE.MeshLambertMaterial({map:gpost}),//color:0x660b0b //map: loader.load('./textures/gatepost.png')
  rugbypost: new THREE.MeshLambertMaterial({map:rpost}),//map: loader.load('./textures/rugbypost.png')}
