...
function makeLight(){
	// LIGHT
	//Attempting to add shadows.
	//difficulty enabling shadow map.
	...
	// var lightHelper = new THREE.DirectionalLightHelper(shadowLight, 50);
...
function makeSkybox(){
	...
	function makeFloor(){
		...
		extendFloor.receiveShadow = true;
